...
~~~~~~~~~~
Version 2.1 (Current)
- Enhanced modular architecture with separated config templates
- Improved PowerShell module compatibility
- Added advanced logging and error handling capabilities
- Streamlined user interface and progress reporting
- Enhanced security and authentication mechanisms

Version 2.0
- Initial comprehensive offboarding automation
- Support for 14 different offboarding operations
- Exchange Online and Microsoft Graph integration
