...
# Get all users
$Users = Get-MgUser -All -Select "id,displayName,userPrincipalName,signInActivity,assignedLicenses,lastpasswordchangeDateTime"
...
foreach ($User in $Users)
{
  ...
  $UserInfo = [PSCustomObject]@{
    ...
    HasMfa            = $HasMfa
    MFAType           = $MFAType
    lastpasswordchangeDateTime = $LastPasswordChangeDate
  }
